...
class BraveDropdownItemViewInfoListBuilder extends DropdownItemViewInfoListBuilder {
    ...
    void onOmniboxSessionStateChange(boolean activated) {
        ...
        if (shouldSkipBraveSuggestionProcessors()) return;
    ...
    List<DropdownItemViewInfo> buildDropdownViewInfoList(
        ...
        if (shouldSkipBraveSuggestionProcessors()) {
            return super.buildDropdownViewInfoList(input, autocompleteResult);
        }
    ...
    private boolean shouldSkipBraveSuggestionProcessors() {
        return mBraveSearchBannerProcessor == null || mBraveLeoSuggestionProcessor == null;
    }
