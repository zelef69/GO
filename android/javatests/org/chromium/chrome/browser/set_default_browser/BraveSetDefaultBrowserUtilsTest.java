...
public class BraveSetDefaultBrowserUtilsTest {
    ...
    public void testBravePackageNames_AreCorrectlyDefined() {
        ...
        assertEquals(
                "Production package name should be com.onetabtube.browser",
                "com.onetabtube.browser",
                BraveConstants.BRAVE_PRODUCTION_PACKAGE_NAME);
        assertEquals(
                "Beta package name should be com.onetabtube.browser_beta",
                "com.onetabtube.browser_beta",
                BraveConstants.BRAVE_BETA_PACKAGE_NAME);
        assertEquals(
                "Dev package name should be com.onetabtube.browser_dev",
                "com.onetabtube.browser_dev",
                BraveConstants.BRAVE_DEV_PACKAGE_NAME);
        assertEquals(
                "Nightly package name should be com.onetabtube.browser_nightly",
                "com.onetabtube.browser_nightly",
                BraveConstants.BRAVE_NIGHTLY_PACKAGE_NAME);
        assertEquals(
                "Debug package name should be com.onetabtube.browser_default",
