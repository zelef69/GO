...
public class BraveSyncCodeCountdownFragment extends Fragment {
    private long mNotAfterEpochSeconds;
    ...
    public void setNotAfter(LocalDateTime notAfter) {
        ...
        calendar.set(
                notAfter.getYear(),
                notAfter.getMonthValue() - 1,
                notAfter.getDayOfMonth(),
                notAfter.getHour(),
                notAfter.getMinute(),
                notAfter.getSecond());
        mNotAfterEpochSeconds = calendar.getTimeInMillis() / 1000L;
        scheduleTextUpdate();
    }
    ...
    void updateText() {
        ...
        Duration duration = Duration.ofSeconds(mNotAfterEpochSeconds - Instant.now().getEpochSecond());
