...
public class BrowsingModeBottomToolbarCoordinator {
    ...
    BrowsingModeBottomToolbarCoordinator(
        ...
        } else if (BottomToolbarVariationManager.isNewTabButtonOnBottomControls()) {
        ...
        } else if (BottomToolbarVariationManager.isTabSwitcherOnBottomControls()) {
    ...
    void initializeWithNative(
        ...
        if (!OneTabYouTubeMode.isEnabled()
            && BottomToolbarVariationManager.isNewTabButtonOnBottomControls()) {
