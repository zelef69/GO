...
public class PlaylistServiceObserverImpl implements PlaylistServiceObserver {
    ...
    public void onItemLocalDataDeleted(String playlistItemId) {
        ...
        if (BraveConfig.IS_ONETABYT) return;
    ...
    private static boolean isVideoPlaybackServiceRunning() {
        try {
            Class<?> hlsUtilsClass =
                    Class.forName("org.chromium.chrome.browser.playlist.hls_content.HlsUtils");
            return Boolean.TRUE.equals(
                    hlsUtilsClass.getMethod("isVideoPlaybackServiceRunning").invoke(null));
