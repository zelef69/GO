...
public final class BraveConstants {
    public static final String BRAVE_ANDROID_PACKAGE_PREFIX = "com.onetabtube.browser";
    ...
    public static final int DEFAULT_BROWSER_ROLE_REQUEST_CODE = 37;
        ...
        public static final String BRAVE_PRODUCTION_PACKAGE_NAME = BRAVE_ANDROID_PACKAGE_PREFIX;
        public static final String BRAVE_BETA_PACKAGE_NAME = BRAVE_ANDROID_PACKAGE_PREFIX + "_beta";
        public static final String BRAVE_DEV_PACKAGE_NAME = BRAVE_ANDROID_PACKAGE_PREFIX + "_dev";
        public static final String BRAVE_NIGHTLY_PACKAGE_NAME =
            BRAVE_ANDROID_PACKAGE_PREFIX + "_nightly";
        public static final String BRAVE_DEBUG_PACKAGE_NAME =
            BRAVE_ANDROID_PACKAGE_PREFIX + "_default";

        public static final String BRAVE_BROWSER_CHANNEL_ID = BRAVE_ANDROID_PACKAGE_PREFIX;
        public static final String BRAVE_ADS_CHANNEL_ID = BRAVE_ANDROID_PACKAGE_PREFIX + ".ads";
        public static final String BRAVE_ADS_BACKGROUND_CHANNEL_ID =
            BRAVE_ANDROID_PACKAGE_PREFIX + ".ads.background";
